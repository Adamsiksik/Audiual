...
class ApiService {
  ...
  Future<Response> resetCheckUser(String user) async {
    ...
    final request = await http
        .post(Uri.parse("http://192.168.1.19:3000/users/reset?Email=${user}"));
  ...
  Future<Response> resetCheckUserkey(String user) async {
    print("sss");
    final request = await http
        .get(Uri.parse("http://192.168.1.19:3000/users/resetkey?key=${user}"));
  ...
  Future<Response> resetCheckUserpass(String key, String pass) async {
    ...
    final request = await http.get(Uri.parse(
        "http://192.168.1.19:3000/users/resetpass?key=${key}&password=${pass}"));
    print("asdasd");
    Response response = Response();
    try {
      if (request.statusCode == 200) {
